<?php
	...
	$sql1 = "SELECT max(nomor) as urut, tiket, DATE_FORMAT(datang,'%d-%m-%Y %H:%i:%s') as datang from antrian1 where tiket = 'a' and DATE_FORMAT(datang,'%Y-%d-%m') = DATE_FORMAT(now(),'%Y-%d-%m')";
