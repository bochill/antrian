...
<head>
    ...
    <script type="text/javascript">
        function tpt() {
            window.open("http://10.12.28.235/antri/tpt.php");
            setTimeout(function() {
        ...
        function helpdesk() {
            window.open("http://10.12.28.235/antri/helpdesk.php");
            setTimeout(function() {
...
<body>
    <div class="container-fluid">
        ...
        <div class="row tombol">
            <div class="col-md-6"><button class="btn btn-xl btn-outline-success btn-block" onclick="tpt()"><b>TPT</b></button></div>
            <div class="col-md-6"><button class="btn btn-xl btn-outline-warning btn-block" onclick="helpdesk()"><b>HELPDESK</b></button></div>
        </div>
    </div>
